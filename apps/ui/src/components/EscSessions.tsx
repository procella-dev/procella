		...
		async (sessionId: string) => {
			...
			try {
				const res = await fetch(
					`${apiBase}/api/esc/v1-internal/environments/${encodeURIComponent(org)}/${encodeURIComponent(project)}/${encodeURIComponent(environment)}/open/${encodeURIComponent(sessionId)}`,
					{
